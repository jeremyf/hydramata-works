  ...
  module Works
    describe Conversions do
      ...
      context '#PredicateSet' do
        it 'converts a "well-formed" Hash to a PredicateSet object' do
        ...
        it 'raises an error when input is unexpected' do
        ...
        it 'handles an Array of 2 elements' do
          expect(PredicateSet([:fieldset, [:predicate1, :predicate2]])).to implement_predicate_set_interface
        end

        it 'handles an Array of 3 elements' do
          expect(PredicateSet([:fieldset, :predicate1, :predicate2])).to implement_predicate_set_interface
        end

        it 'handles an Array of 1 element' do
        ...
        it 'uses #to_predicate_set for conversion if input responds to #to_predicate_set' do
