...
describe 'hydramata/works/works/_show.html.erb', type: :view do
  ...
  let(:object) { double('Object', actions: [action], fieldsets: [fieldset1, fieldset2], container_content_tag_attributes: dom_attributes) }
  ...
  let(:action) { double('Action', render: '<div id="action_1">Action 1</div>'.html_safe) }
