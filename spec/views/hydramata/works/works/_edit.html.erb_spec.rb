...
describe 'hydramata/works/works/_edit.html.erb', type: :view do
  ...
  it 'renders the object and fieldsets' do
    ...
    expect(fieldset1).to have_received(:render).with(view, locals: { form: kind_of(ActionView::Helpers::FormBuilder) })
    expect(fieldset2).to have_received(:render).with(view, locals: { form: kind_of(ActionView::Helpers::FormBuilder) })
