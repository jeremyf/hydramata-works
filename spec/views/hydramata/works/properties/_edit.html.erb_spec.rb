...
describe 'hydramata/works/properties/_edit.html.erb', type: :view do
  ...
  let(:presenter) { Hydramata::Works::PropertyPresenter.new(property: property, work: work, presentation_context: :edit) }
  let(:form) { double('Form') }

  it 'renders the object and fieldsets' do
    allow(presenter).to receive(:with_text_for).with(:help).and_yield('This is a hint')
    render partial: 'hydramata/works/properties/edit', object: presenter, locals: { form: form }
